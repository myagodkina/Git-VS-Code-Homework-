...
Для формирования ненумерованного необходимо поставить перед текстом знак "звездочка" и <u>пробел</u> или знак "плюс" и <u>пробел</u>.
* *Пример
+ +Пример
...
Для формирования нумерованного необходимо поставить перед текстом <u>число, точку и пробел</u>:
1. Пример
2. Пример
